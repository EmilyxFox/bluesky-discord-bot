...
import { type ChatInputCommandInteraction, EmbedBuilder, InteractionContextType, MessageFlags, PermissionFlagsBits, SlashCommandBuilder } from "discord.js";
      ...
      case "add": {
        ...
        if (didRegex.test(didorhandle)) {
          ...
          return await interaction.reply({
            content: "The string provided doesn't seem to be either a DID or a handle.\n-# If you think this error is wrong please contact the developer.",
        ...
        try {
          ...
          if (error.message.includes("UNIQUE constraint")) {
            ...
            return await interaction.reply({
              content: "This Bluesky account is already subscribed to this channel.\n-# If you think this is an error, please contact the developer.",
              flags: MessageFlags.Ephemeral,
            });
          }
          console.log(error);
          return await interaction.reply({
            content: "An unknown error has occurred. Please contact the developer about this issue.",
            flags: MessageFlags.Ephemeral,
          });
        }
        break;
